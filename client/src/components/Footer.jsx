...
const Footer = () => {
  return (
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-60 text-sm text-gray-500'>
            <div className='flex items-start flex-wrap justify-between gap-8 pb-6 border-borderColor border-b'>
                <div>
                    <img src={assets.logo}alt="logo" className='h-8 md:h-9' />
                    <p className='max-w-60 mt-3'>
                ...
                <div>
                    ...
                    <ul className='mt-3 flex flex-col gap-1.5 text-sm'>
                        ...
                        <li>San Franciso, CA 94107</li>
                        <li>+1 234 56890</li>
                        <li>info@roadride.com</li>
                    </ul>
                </div>
            </div>
