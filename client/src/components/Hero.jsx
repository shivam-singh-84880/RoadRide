...
const Hero = () => {
  ...
  return (
    ...
    className='h-screen flex flex-col items-center justify-center gap-8 bg-light text-center'>
        ...
        className='py-4 text-4xl md:text-5xl font-semibold'>Luxury cars on Rent</motion.h1>
        ...
        <motion.img initial={{y: 100, opacity: 0}} animate={{y: 0, opacity: 1}} transition={{duration: 0.8, delay: 0.6}} className='max-h-74' src={assets.main_car} alt="car" />
