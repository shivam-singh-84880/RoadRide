...
const Testimonial = () => {
    ...
    const testimonials = [
        ...
        testimonials: "I have rented cars from various companies, but the experience with RoadRide was exceptional!" 
        },
        {name: "John Abrahim", location: "New York, USA", 
        image: assets.testimonial_image_2,
        testimonials: "RoadRide made my trip so much easier. The car was delivered right to my door, and the customer service was fantastic!" 
        },
