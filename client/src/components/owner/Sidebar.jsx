    ...
    <div className='relative min-h-screen md:flex flex-col items-center pt-8 max-w-13 md:max-w-60 w-full border-r border-borderColor text-sm'>
        <div className='group relative'>
            <label htmlFor='image'>
                ...
                'https://images.unsplash.com/photo-1633332755192-727a05c4013d?q=80& w=300'} alt="user image" className='h-9 md:h-14 w-9 md:w-14 rounded-full mx-auto'/>
        ...
        {image && (
            <button className='absolute top-0 right-0 flex p-2 gap-1 bg-primary/10 text-primary cursor-pointer'>
                Save <img src={assets.check_icon} width={13} alt="check icon" onClick={updateImage}/>
            </button>
        )}
