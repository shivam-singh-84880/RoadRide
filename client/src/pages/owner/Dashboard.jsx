...
const Dashboard = () => {
  ...
  const DashboardCards = [
    ...
    { title: 'Pending Bookings', value: data.totalPendingBookings, icon: assets.cautionIconColored },
    { title: 'Completed Bookings', value: data.totalCompletedBookings, icon: assets.listIconColored },
  ]
    ...
    <div className='px-4 pt-10 md:px-10 flex-1'>
        ...
        {DashboardCards.map((card, index) => (
          <div key={index} className='flex gap-2 items-center justify-between p-4 rounded-md border border-borderColor'>
            ...
            <div className='flex items-center justify-center h-10 w-10 rounded-full bg-primary/10'>
              <img src={card.icon} alt="card"  className='h-4 w-4'/>
            </div>
          </div>
        ))}
      </div>
      ...
      <div className='flex flex-wrap items-start gap-6 mb-8 w-full'>
        ...
        <div className='p-4 md:p-6 mb-6 border border-borderColor rounded-md w-full md:max-w-xs'>
          ...
          <p className='text-gray-500'>Revenue generated from bookings this month</p>
